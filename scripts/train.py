...
@click.option(
    "--mean_intensity_mode",
    type=click.Choice(["none", "cls_residual", "per_channel", "both"]),
    default="cls_residual",
    ...
    if freeze_backbone:
        ...
        if n_trainable == 0:
            raise click.UsageError(
                "--freeze_backbone with no branch trainable — did you also pass --mean_intensity_mode?"
            )
